...
public class NetworkUtils {
    ...
    public static String getBookInfo(String queryString){
        ...
        try {
            ...
            ulrConnection = (HttpURLConnection) url.openConnection();
            ulrConnection.setRequestMethod("GET");
            ulrConnection.connect();

            InputStream inStream = ulrConnection.getInputStream();
